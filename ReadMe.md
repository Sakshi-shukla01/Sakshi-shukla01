...
I'm a **Full-Stack & AI Engineer** interested in building systems that combine
software engineering, machine learning, and real-world applications.

- 🔬 Research Intern at **ARDE, DRDO**
...
### Research Intern — ARDE, DRDO

**August 2026 – Present**

Working as a Research Intern at the **Armament Research & Development
Establishment (ARDE), DRDO**.

ARDE is a DRDO laboratory involved in research and development related to
armament and ammunition systems.
...
Full-stack SaaS movie booking platform designed around concurrent seat
...
`React` `Node.js` `MongoDB` `Stripe` `Inngest` `Clerk`
...
<img src="https://skillicons.dev/icons?i=fastapi,flask,django,nodejs,express&perline=8"/>

</div>

**Experience with**

`REST APIs` `Authentication` `JWT` `Webhooks` `Background Jobs`
`Client-Server Architecture` `API Integration`
...
`Canvas APIs` `Component Architecture`
...
`Schema Design` `Indexing` `Aggregation` `Query Optimization`
...
`SDLC` · `Agile/Scrum` · `Git` · `Code Review`
